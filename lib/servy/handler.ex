defmodule Servy.Handler do
  ...
  def route(%Conv{method: "GET", path: "/sensors/bigfoot"} = conv) do
    ...
    where_is_wildthing = Task.await(task)

    View.render(conv, "api_results.eex", snapshots: snapshots, coordinates: where_is_wildthing)
  end
